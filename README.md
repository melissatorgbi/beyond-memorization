...
| 3          | Zero-shot  | None                  | None                                                                         | abstraction_constructional_NLI/abstraction_CxNLI_test.tsv                                |
| 3          | One-shot   | CxNLI                 | constructional_NLI/CxNLI_1_example_train.csv                                 | abstraction_constructional_NLI/abstraction_CxNLI_test.tsv                                |
| 3          | Three-shot | CxNLI                 | constructional_NLI/CxNLI_3_examples_train.csv                                | abstraction_constructional_NLI/abstraction_CxNLI_test.tsv                                |
| 3          | One-shot   | SNLI                  | constructional_NLI/SNLI_1_example_train.csv                                  | abstraction_constructional_NLI/abstraction_CxNLI_test.tsv                                |
| 3          | Three-shot | SNLI                  | constructional_NLI/SNLI_3_examples_train.csv                                 | abstraction_constructional_NLI/abstraction_CxNLI_test.tsv                                |
