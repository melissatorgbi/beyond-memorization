...
| 3          | Zero-shot  | None                  | None                                                                         | CxNLI_distinction/abstraction_CxNLI_test.tsv                                |
| 3          | One-shot   | CxNLI                 | CxNLI/CxNLI_1_example_train.csv                                 | CxNLI_distinction/abstraction_CxNLI_test.tsv                                |
| 3          | Three-shot | CxNLI                 | CxNLI/CxNLI_3_examples_train.csv                                | CxNLI_distinction/abstraction_CxNLI_test.tsv                                |
| 3          | One-shot   | SNLI                  | CxNLI/SNLI_1_example_train.csv                                  | CxNLI_distinction/abstraction_CxNLI_test.tsv                                |
| 3          | Three-shot | SNLI                  | CxNLI/SNLI_3_examples_train.csv                                 | CxNLI_distinction/abstraction_CxNLI_test.tsv                                |
